      ...
      <div className="flex flex-wrap">
        ...
        <div className="w-full md:w-1/2 lg:w-6/12">
          <div className="product-single">
            <h2 className="text-xl font-semibold">iPhone 13 256GB Chính hãng (VN/A)</h2>
            ...
            <p className="product-price text-2xl mt-2">
              25.350.000đ
              <strike className="text-gray-400 ml-2 text-base">27.990.000đ</strike>
            </p>
            ...
            <div className="buttons flex items-center mt-4">
              <button className="btn btn-default btn-buy-now bg-blue-500 text-black py-2 px-4 rounded-full mr-4">
                Mua Ngay
              </button>
              <button type="submit" className="btn btn-default bg-green-500 text-black py-2 px-4 rounded-full">
        ...
        <div className="w-full">
          <div className="box-head scroll-nav">
            <div className="head-title">
              ...
              <Link
                to="#product"
                className={`page-scroll text-blue-500 hover:text-blue-700 ${activeSection === 'product' ? 'font-bold' : ''}`}
              ...
              <Link
                to="#rating"
                className={`page-scroll text-blue-500 hover:text-blue-700 ${activeSection === 'rating' ? 'font-bold' : ''}`}
              ...
              <Link
                to="#review"
                className={`page-scroll text-blue-500 hover:text-blue-700 ${activeSection === 'review' ? 'font-bold' : ''}`}
      ...
      <div className="flex flex-wrap mt-8">
        <div className="w-full">
          {activeSection === 'product' && (
            <div className="description-details">
              <div className="description-left">
                ...
                <p>
                  Đây là mô tả chi tiết về sản phẩm, thông tin kỹ thuật và các đặc điểm nổi bật.
                </p>
              </div>
            </div>
          )}
          ...
          {activeSection === 'rating' && (
            <div id="rating">
              <div className="box container-rating-review">
                <h3 className="text-2xl font-semibold">Đánh giá và nhận xét</h3>
                {/* Add ratings and reviews content here */}
                <p>Đây là phần đánh giá và nhận xét của người dùng về sản phẩm.</p>
              </div>
            </div>
          )}
          ...
          {activeSection === 'review' && (
            <div id="review">
              <div className="box">
                <h3 className="text-2xl font-semibold">Đánh giá và nhận xét của bạn</h3>
