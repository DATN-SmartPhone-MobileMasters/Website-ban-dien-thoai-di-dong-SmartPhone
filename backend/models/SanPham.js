...
const SanPhamSchema = new mongoose.Schema({
  ...
  SoLuongMau1_1: {type: String},
  SoLuongMau1_2: {type: String},
  SoLuongMau1_3: {type: String},
  SoLuongMau2_1: {type: String},
  SoLuongMau2_2: {type: String},
  SoLuongMau2_3: {type: String},
  SoLuongMau3_1: {type: String},
  SoLuongMau3_2: {type: String},
  SoLuongMau3_3: {type: String},
  Mau1: { type: String },
  Mau2: { type: String },
  Mau3: { type: String },
  ManHinh: { type: String },
